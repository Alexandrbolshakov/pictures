...
/* harmony import */ var _modules_hoseCalc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/hoseCalc */ "./src/js/modules/hoseCalc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_hoseCalc__WEBPACK_IMPORTED_MODULE_7__["default"])('#nutSize', '.hoseLenght', '.hose-price');
...
var accordion = function accordion(triggerSelector) {
  ...
  //     block.classList.add('animate', 'fadeInDown');
  // });
  // btns.forEach(btn=>{
  //     btn.addEventListener('click', function(){
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var hoseCalc = function hoseCalc(nut, hose, result) {
  var nutBlock = document.querySelector(nut),
...
/* harmony default export */ __webpack_exports__["default"] = (hoseCalc);
...
var scrolling = function scrolling(upSelector) {
  ...
  //     body = document.body;
  // const calcScroll = () =>{
  //     upElem.addEventListener('click', function(element){
  ...
  //         ){ 
  //             clearInterval(move);
  //             histoty.replaceState(history.state, document.title, location.href.replace(/#.*$/g, '')+ hash);
  //         }else{
